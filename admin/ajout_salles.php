...
if (isset($_POST['submit'])) 
{
	...
	$sql_classe = $bdd->prepare("SELECT * FROM salles WHERE salle = :salle");
	...
	if (!isset($info_classe['id'])) 
	{
		try 
		{
		    $sql = "INSERT INTO salles (id, salle) 
		    VALUES (NULL, '".$salle."')";
		    $bdd->exec($sql);
		    /*-------------------------------------------------------------A CHANGER !!!!!!!!!!!!!!!!!!!!!!!!!-------------------------------------------------------------------------
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
	...
	{
		echo '<script>alert("Attention cette salle existe déjà. Veuillez en saisir un autre.");</script>';
	}
...
<body ng-app="SignUp">
	<div id="container">
		<header>
			...
			<section>
				<div>	
					<form action="ajout_salles.php" method="post">
						<table class="table_ajout">
							<tr>
								<td>
									<div id="salle" class="div_ajout">
										<input class="input_ajout" name="salle" type="text" placeholder="Salle">
									</div>
								</td>
							</tr>
							<tr>
